...
picture_list = list(range(1, 400))
novel_list = list(range(1, 400))
...
while continueRoutine:
    ...
    #    n_theseKeys = 0
    #    while n_theseKeys < 5:
    #        key_just_pressed = welcome_key_resp.getKeys(keyList=['space'], waitRelease=False)
    #        theseKeys.extend(key_just_pressed)
     #       time_pressed = tThisFlipGlobal
      #      if ("escape" in theseKeys):
       #         endExpNow = True
        #    #print(time_pressed)
         #   #thisExp.addData('timepressed.started', time_pressed)
       # print(theseKeys, time_pressed)
       # if len(theseKeys) == 5:
...
for thisTraining in trainings:
    ...
    path_string_1 = str(showing_1) + ".jpg"
    path_string_2 = str(showing_2) + ".jpg"
    path_string_3 = str(showing_3) + ".jpg"
    path_string_4 = str(showing_4) + ".jpg"
    
    path1 = os.path.join('pictures', path_string_1)
    path2 = os.path.join('pictures', path_string_2)
    path3 = os.path.join('pictures', path_string_3)
    path4 = os.path.join('pictures', path_string_4)
    
    training_picture1 = visual.ImageStim(
    win=win,
    name='traning_picture1', 
